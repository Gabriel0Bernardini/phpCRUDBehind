...
<body>
    ...
    <div class="dropdown" style="font-family: DogicaBold;">
        <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" style="background: rgb(4, 64, 3); height: 60px; width: 20%;font-size:20px;">
            Menu
        </button>
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="index.php">Home</a></li>
            <li><a class="dropdown-item" href="selectUsuario.php">Lista</a></li>
