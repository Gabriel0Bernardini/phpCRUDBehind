...
<div class="p-4 link" style="display: block; ">
    <a href="index.php" class="link aNavLink">Home</a> 
    <a href="cadastro.php" class="link aNavLink">Cadastro</a>
    <a href="login.php" class="link aNavLink">Login</a>
    <a href="selectUsuario.php" class="link aNavLink">Usuários</a>
  </div> 
</div>
</nav>